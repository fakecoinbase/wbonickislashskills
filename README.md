...
3. Bitcoin price prediction - an attempt to evaluate bitcoin price relationship with market assets like oil WTI price, gold price, SP500 index, M2 money supply etc. So far regression (multilinear and nonlinear) and tree-based models are built. __This project is still in progress.__ 
